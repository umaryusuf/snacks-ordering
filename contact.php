			...
			<section class="container">
				<div class="col-md-6">
					...
					<form action="mail/contact_me.php" method="POST" role="form">
						<fieldset>
							<legend>Send us your message questions or recommendations below:</legend>
				...
				<div class="col-md-6">
					...
					<br>
					<address>
						<p><span class="fa fa-envelope"></span> email: info@email.com</p>
						<p><span class="fa fa-phone"></span> phone: +234 806 **** ***</p>
						<p><span class="fa fa-map-marker"></span> No 22 - 26, delicious road</p>
						<p>Barnawa, Kaduna Nigeria.</p>
					</address>
